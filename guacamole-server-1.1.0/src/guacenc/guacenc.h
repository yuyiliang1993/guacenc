...
extern int job_listen_socket_init(short port);//in jobs.c
extern int job_accept_callback(int fd, int events, void *arg);//in jobs.c

typedef struct server_inter{
    sem_t sem;//信号量
    int thread_window_size;//线程窗口大小
